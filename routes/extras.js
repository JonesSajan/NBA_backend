...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
router.get("/displaypercentagemidterm1attendance60", function (req, res, next) {
  console.log(req.body);
  pool.query("select * from midterm1_marks", function (error, result) {
    if (error) {
      res.status(500).json([]);
        ...
        if (!findSub(result[i].subcode)) {
          for (let j = 0; j < result.length; j++) {
            if (result[i].subcode === result[j].subcode) {
              ...
              ////////////////////////////////////////////////////////////////////////////////////////////////////////
              if (result[j].mark_of_q1a>0) {
                attend.mark_of_q1a++;
              }
              if (result[j].mark_of_q1b>0) {
                attend.mark_of_q1b++;
              }
              if (result[j].mark_of_q1c>0) {
                attend.mark_of_q1c++;
              }
              if (result[j].mark_of_q1d>0) {
                attend.mark_of_q1d++;
              }
              if (result[j].mark_of_q1e>0) {
                attend.mark_of_q1e++;
              }
              if (result[j].mark_of_q2a>0) {
                attend.mark_of_q2a++;
              }
              if (result[j].mark_of_q2b>0) {
                attend.mark_of_q2b++;
              }
              if (result[j].mark_of_q2c>0) {
                attend.mark_of_q2c++;
              }
              if (result[j].mark_of_q3>0) {
                attend.mark_of_q3++;
              }
              if (result[j].mark_of_q4 >0) {
                attend.mark_of_q4++;
              }
            }
          }
          marks.mark_of_q1a=marks.mark_of_q1a*100/(attend.mark_of_q1a==0?1:attend.mark_of_q1a)
          marks.mark_of_q1b=marks.mark_of_q1b*100/(attend.mark_of_q1b==0?1:attend.mark_of_q1b)
          marks.mark_of_q1c=marks.mark_of_q1c*100/(attend.mark_of_q1c==0?1:attend.mark_of_q1c)
          marks.mark_of_q1d=marks.mark_of_q1d*100/(attend.mark_of_q1d==0?1:attend.mark_of_q1d)
          marks.mark_of_q1e=marks.mark_of_q1e*100/(attend.mark_of_q1e==0?1:attend.mark_of_q1e)
          marks.mark_of_q2a=marks.mark_of_q2a*100/(attend.mark_of_q2a==0?1:attend.mark_of_q2a)
          marks.mark_of_q2b=marks.mark_of_q2b*100/(attend.mark_of_q2b==0?1:attend.mark_of_q2b)
          marks.mark_of_q2c=marks.mark_of_q2c*100/(attend.mark_of_q2c==0?1:attend.mark_of_q2c)
          marks.mark_of_q3=marks.mark_of_q3*100/(attend.mark_of_q3==0?1:attend.mark_of_q3)
          marks.mark_of_q4=marks.mark_of_q4*100/(attend.mark_of_q4==0?1:attend.mark_of_q4)
